public class Account{
	...
	private Transaction listOfTransaction[];   //Updated part
	private int totalNumberOfTransaction;      //Updated part
	...
	Account(String accName,String acId,int balance){
		...
		this.listOfTransaction=new Transaction[5];                  //Updated part
		this.totalNumberOfTransaction=totalNumberOfTransaction;    //Updated part
	}
...
//UPDATED PART	
	...
	public void addTransaction(Transaction t){
		...
		{
			if(totalNumberOfTransaction<100)
			{
				listOfTransaction[totalNumberOfTransaction]=t;
		        totalNumberOfTransaction++;
			}
			else
				System.out.print("\nMaximum number of transactions has been reached for this account");
		}
	}
	
	public void removeTransaction(Transaction t){
		for(int i=0;i<totalNumberOfTransaction;i++)
			if(listOfTransaction[i]==t)
			{
				listOfTransaction[i] = listOfTransaction[totalNumberOfTransaction-1];
				totalNumberOfTransaction--;
			}
	}
